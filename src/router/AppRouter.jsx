...
import BenificiaryWorkEntry from "../pages/beneficiary/BenificiaryWorkEntry";
import PerformanceMonitoringSystem from "../pages/PMS/PerformanceMonitoringSystem";
import InspectionDetailsReport from "../pages/Reports/InspectionDetailsReport";
import DistrictPerformanceRankings from "../pages/PMS/DistrictPerformanceRankings";
import FundReconciliationReport from "../pages/ecash/FundReconciliationReport";
import GetHead from "../pages/master/GetHead";
import GetSubHead from "../pages/master/GetSubHead";
import BenificiaryPayment from "../pages/master/BenificiaryPayment";
